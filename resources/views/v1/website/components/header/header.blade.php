      ...
      <nav id="site-navigation" class="main-navigation" role="navigation">
        <div class="menu-main-menu-container">
          <ul id="primary-menu" class="menu">
            ...
            <li id="menu-item-200" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-200 {{ Request::is('learning-management-system') ? 'current-menu-item' : '' }}"><a href="{{route('website.lms')}}" onclick="window.open('http://178.128.214.154/lms');">Learning Management System</a></li>
